...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="container">
      ...
      <h5 class="text-center text-uppercase p-2" style="text-decoration: underline; font-weight: bold;">Bon de Commande</h5>
      <div class="row p-2">
    ...
    <form method="POST" action="../../controlleur/traitementFacture.php"  enctype="multipart/form-data" >
      <div class="row p-4">
        <div class="col-md-3 offset-3">
            <a href="imprimerBC.php" class="btn btn-warning"><i class="fas fa-print"></i><input type="button" name="imprimerFD" class="btn btn-warning" value="Imprimer la facture" ></a>
