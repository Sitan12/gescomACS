...
<div class="container-fluid">
  <div class="row">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../gestionComptabilite/caisse.php">
              <span data-feather="layers"></span>
              <i class="fas fa-calculator"></i> Caisse
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../gestionComptabilite/banque.php">
              <span data-feather="layers"></span>
              <i class="fas fa-calculator"></i> Banque
            </a>
          </li>
        </ul>
    ...
    <main class=" container all-content-wrapper" style="margin-left: 220px; margin-bottom: 30px">
...
<form class=" p-4" method="POST" action="EditText.php" enctype="multipart/form-data">
          <div class="row">
            <div class="offset-2 card bg-light p-4 col-md-8 ">
                <h4 class="text-center p-1 card" style="background-color:#32459D; color:white; font-style:italic">Formulaire de modification produit</h3>
          ...
          ?>" required>
              ...
              <textarea class="form-control" name="descriptionPro" rows="3" required 
              ><?php $rst=$conn->query("SELECT descriptionProduit FROM produit WHERE id=$id");
            while($row=$rst->fetch_assoc()){
              echo''.$row['descriptionProduit'];
            }
          ?></textarea> 
              <label >Nouvelle Image Produit</label>
