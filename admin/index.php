...
<body style="background-Color: #32459D;">
    <div class="container">
        <div class="row d-flex justify-content-center mt-5 p-4 " >
            <div class=" card col-md-6 p-4 mt-5" >
            <img src="static/img/logo ACS.png" style="width: 30%; height: 30%;">
          ...
          echo '</div>';
			...
			?>
                            <div class="row justify-content-end">
                                <a class="float-right" style="font-weight: bold;" href="MotDePasseOublie.php">Mot de Passe Oublié?</a>
                            </div>
                            <div class="row justify-content-center">
                                 <input type="submit" style="font-weight: bold;" class="btn btn-success" name="login" value="Se Connecter">
                            </div>
                        </form>
                </div>
            </div>
