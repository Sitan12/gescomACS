...
<header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow" style="background-Color: #32459D;">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 bg-light text-center" href="#"><img src="static/img/logo ACS.png" width="80" alt="logo"></a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-4">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vue/gestionFournisseur/fournisseur.php">
              <span data-feather="layers"></span>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="vue/gestionComptabilite/caisse.php">caisse</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="vue/gestionComptabilite/banque.php">banque</a></li>
          </ul>
          </li>
        </ul>
    ...
    <main class=" container all-content-wrapper" style="margin-left: 220px;">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
            <img class="p-4" src="static/img/logo ACS.png" style="width: 75%; height: 65%;">
            <h2 class="mb-3" >ALLIANCE CUSTOMER SERVICE</h2>
        </div>
      </div>
     <div class="row p-4 justify-content-center">
        <div class="text-center col-md-8 p-4 card">
        <h2 >A Propos</h2>
        <p>
           ACS (Alliance Customer Service) est une SARL (Société à Responsabilité Limité) évoluant dans le domaine du froid industriel et domestique. 
            Elle est inscrite au registre de commerce et crédit mobilier de DAKAR sous le n° SN DKR 2015 B 7111 et dont le siège se trouve à Pikine cite Lobat FALL villa n°44.
        </p>
        </div>
     </div>
