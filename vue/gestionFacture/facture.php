...
<div class="container">
    ...
    <div class="col-3">
                  <a href="../gestionClient/client.php"><button class="btn btn-success">Nouveau Client</button></a>
                  </div>
    ...
    <div class="input-field">
              ...
              <div class="col-4 mb-3"><?php
                  ...
                  <div class="col-3 input-group mb-3 ">
                   ...
                   <input type="number" class="form-control" name="tva" placeholder="18%"> 
                  </div>
      ...
      <?php while($row = $result->fetch_assoc()){?><option value="<?=$row['id']?>"><?=$row['nomProduit']?></option><?php } ?>
        ...
        <center>
        <button class="btn btn-success" name="save">Visualiser la facture</button>
        </center>
    </div>  
  </form>     
